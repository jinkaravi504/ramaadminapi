package com.rama.web.rest;

import com.rama.config.Constants;
import com.rama.RamaadminapiApp;
import com.rama.domain.Authority;
import com.rama.domain.User;
import com.rama.repository.AuthorityRepository;
import com.rama.repository.UserRepository;
import com.rama.security.AuthoritiesConstants;
import com.rama.service.MailService;
import com.rama.service.dto.UserDTO;
import com.rama.web.rest.errors.ExceptionTranslator;
import com.rama.web.rest.vm.KeyAndPasswordVM;
import com.rama.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = RamaadminapiApp.class)
